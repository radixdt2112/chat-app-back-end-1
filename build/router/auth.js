        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, userServices_1.createUser)(profile.displayName, profile.emails[0].value)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, cb(null, result)];
            }
        });
    });
}));
...
router.get('/oauth2/redirect', passport_1.default.authenticate('google'), function (req, res) {
    var url = new URL(process.env.CLIENT_URL
        ? process.env.CLIENT_URL + 'loader'
        : 'http:localhost:3000/loader');
    if (req.user) {
        for (var _i = 0, _a = Object.entries(req.user); _i < _a.length; _i++) {
